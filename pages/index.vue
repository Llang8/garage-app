  ...
  <div class="index">
    ...
    <div class="results-container">
      <div class="result" v-for="(sale, index) in sales">
        ...
        <svg @click="removeBookmark(sale.id)" v-if="bookmarked.includes(sale.id) || bookmarkQueue.includes(sale.id)" version="1.1"  width="9" height="18"  style="float: right; margin-left: 5px;enable-background:new 0 0 9 18;" id="Layer_1" x="0px" y="0px"
        viewBox="0 0 9 18">
